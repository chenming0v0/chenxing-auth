...
pub use config_limit_bounds::{
    ...
    MAX_EXTERNAL_LOGIN_STATE_TTL_SECONDS, MAX_IP_FAILURE_LIMIT, MAX_PENDING_REQUEST_TTL_SECONDS,
    MAX_PENDING_REQUESTS_GLOBAL, MAX_PENDING_REQUESTS_PER_CLIENT, MAX_TOTP_TICKET_FAILURE_LIMIT,
