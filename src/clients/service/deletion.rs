...
impl ClientService {
    pub async fn delete_with_audit(
        ...
        self.delete_in_scope_with_audit(None, client_id, Some(management_actor), audit_event)
            .await
    }
    ...
    pub async fn delete_for_user_with_audit(
        ...
        self.delete_in_scope_with_audit(Some(owner_user_id), client_id, None, audit_event)
            .await
    }
    ...
    async fn delete_in_scope_with_audit(
        ...
        let deleted = repository::delete_client_with_audit(
            &self.pool,
            owner_user_id,
            client_id,
            management_actor,
        ...
        .await
        .map_err(|error| super::map_audited_mutation(error, "client_delete.audit_unavailable"))?;
        if deleted {
