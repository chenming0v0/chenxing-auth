...
impl ConsentRepository for PgConsentRepository {
    ...
    async fn list_active_for_user(
        ...
        let rows = crate::sqlx::query_as::<_, (String, String, Json<Vec<String>>, OffsetDateTime, Option<String>, Option<String>, Option<String>)>(
            "SELECT oc.client_id, oc.client_name, c.scopes, c.updated_at, oc.logo_uri, oc.client_uri, oc.description
             FROM user_consents c
             JOIN oauth_clients oc ON oc.id = c.client_id
