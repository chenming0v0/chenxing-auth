...
audit_actions! {
    ...
    QuotaAddonCreate => "quota_addon_create" => (Account, Notice),
    QuotaAddonUpdate => "quota_addon_update" => (Account, Notice),
    QuotaAddonArchive => "quota_addon_archive" => (Account, Notice),
    QuotaAddonPurchase => "quota_addon_purchase" => (Account, Notice),
    WalletCredit => "wallet_credit" => (Account, Critical),
    WalletRedemption => "wallet_redemption" => (Account, Critical),
    WalletRedemptionCodeCreate => "wallet_redemption_code_create" => (Account, Critical),
    WalletRedemptionCodeDisable => "wallet_redemption_code_disable" => (Account, Critical),
