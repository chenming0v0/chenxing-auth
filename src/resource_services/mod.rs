...
pub use scopes::{
    ProviderScope, ScopeCatalogItem, ScopeSource, client_scope_allowlist, filter_scopes,
    scoped_client_service,
};
pub use secret::SecretString;
pub use service::{ResourceServiceService, ScopeDeclaration, default_scope};
...
pub use types::{
    ...
    OperationRow, OutboxRow, ProviderRow, ScopeAccess, classify_existing_operation,
};
