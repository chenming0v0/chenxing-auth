...
use crate::account_portal::client::AccountProviderClient;
use crate::account_portal::metadata::ProviderMetadata;
use crate::account_portal::secret::SecretString;
use crate::account_portal::service_error::ServiceError;
use crate::account_portal::store::{self, Store, StoreError};
use crate::account_portal::views::AdminProviderView;
...
impl AccountPortalService {
    ...
    pub async fn create_provider(
        ...
        let issuer = crate::account_portal::scalar::Issuer::parse(&input.issuer)
    ...
    async fn fetch_metadata(
        &self,
        issuer: &crate::account_portal::scalar::Issuer,
        client_id: &str,
        secret: &SecretString,
