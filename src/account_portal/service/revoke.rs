...
use crate::account_portal::store::Store;
use crate::account_portal::views::{BindingView, PublicProviderView};
...
impl AccountPortalService {
    pub async fn unlink_binding(
        ...
        .map_err(|error| match error {
            crate::account_portal::store::StoreError::Database(error) => ServiceError::from(error),
