...
pub async fn find_identity(
    ...
    crate::sqlx::query_as::<_, (Uuid, Uuid, Uuid, String, String, String)>(
...
pub async fn create_user_with_identity(
    ...
    subject: &str,
    password_hash: &str,
) -> Result<Uuid, CreateIdentityError> {
    ...
    crate::sqlx::query(
        "INSERT INTO users
         (id, email, password_hash, password_login_enabled, display_name, status, created_at)
