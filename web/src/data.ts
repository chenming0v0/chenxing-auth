...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: '已连接账号', path: '/console/account/oauth-identities', icon: 'fingerprint' },
      { label: '账号门户', path: '/console/account/portal', icon: 'key-round' },
...
export const pageStatus: Record<string, string> = {
  ...
  '/console/account/oauth-identities': '控制台 · 已连接账号',
  '/console/account/portal': '控制台 · 账号门户',
  ...
  '/admin/users': '管理 · 用户管理',
  '/admin/plans': '管理 · 套餐管理',
  '/admin/clients': '管理 · 认证链接',
  '/admin/app-links': '管理 · 软件链接',
  '/admin/audit': '管理 · 审计日志',
