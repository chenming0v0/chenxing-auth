...
export const ACTION_CATALOG: Record<string, ActionInfo> = {
  ...
  resource_service_provider_save: { label: '保存资源服务', severity: 'critical' },
  resource_service_provider_disable: { label: '停用资源服务', severity: 'warning' },
  resource_service_bind: { label: '绑定资源服务账号', severity: 'notice' },
  resource_service_bind_failure: { label: '资源服务绑定失败', severity: 'warning' },
  resource_service_refresh: { label: '刷新资源服务令牌', severity: 'notice' },
  resource_service_unlink: { label: '解绑资源服务账号', severity: 'critical' },
  resource_service_exchange: { label: '资源服务会话兑换', severity: 'notice' },
  resource_service_exchange_denied: { label: '资源服务会话兑换被拒绝', severity: 'warning' },
...
export const RESOURCE_LABELS: Record<string, string> = {
  session: '会话',
  user: '用户',
  resource_service_provider: '资源服务',
  resource_service_binding: '资源服务绑定',
