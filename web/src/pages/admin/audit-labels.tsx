...
export const ACTION_CATALOG: Record<string, ActionInfo> = {
  ...
  account_portal_provider_save: { label: '保存账号门户提供方', severity: 'critical' },
  account_portal_provider_disable: { label: '停用账号门户提供方', severity: 'warning' },
  account_portal_bind: { label: '绑定账号门户', severity: 'notice' },
  account_portal_bind_failure: { label: '账号门户绑定失败', severity: 'warning' },
  account_portal_refresh: { label: '刷新账号门户令牌', severity: 'notice' },
  account_portal_unlink: { label: '解绑账号门户', severity: 'critical' },
...
export const RESOURCE_LABELS: Record<string, string> = {
  ...
  account_portal_provider: '账号门户提供方',
  account_portal_binding: '账号门户绑定',
