...
fn database_uses_explicit_unified_baseline_migrations() {
    ...
    assert!(DB_MODULE.contains("0024_user_canonical_email.sql"));
    ...
    assert_eq!(
        ...
        vec![
            ...
            std::ffi::OsString::from("0024_user_canonical_email.sql"),
        ]
    );
}
...
fn canonical_email_migration_fails_loudly_instead_of_merging_accounts() {
    let migration = include_str!("../migrations/0024_user_canonical_email.sql");
    for marker in [
